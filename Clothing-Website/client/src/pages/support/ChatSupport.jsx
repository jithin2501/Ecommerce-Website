        ...
        <main className="cs-main-wrapper">
          <div className="cs-chat-wrap">
            ...
            <div className="cs-chat-header">
              <button className="mobile-back-btn cs-back-btn" onClick={() => navigate('/support')}>
                <span className="back-chevron">
                  <svg width="24" height="24" viewBox="1.5 0 24 24" fill="none" stroke="white" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
              ...
              {messages.map((msg, i) => {
                ...
                return (
                  <div key={i} className={`cs-msg cs-msg--${msg.from}`}>
                    {msg.from === 'bot' && <div className="cs-avatar"><img src="/images/logo/logo.png" alt="ST" className="cs-logo-img-small" /></div>}
